...
export class TestComponent {
  ...
  selectedType: string = 'all';
    ...
    cars: Car[] = [
      { name: 'Car 1', image: './assets/suv6.jfif', model: 'Model 1', type: 'basic', rentalDetails: { pricePerKm: 10, discount: 20, perDayCost: 500 }, details: 'Economical and fuel-efficient', gearType: 'manual', isFrequentRenter: true, loyaltyPoints: 0, extraDiscountRides: 0 },
      { name: 'Car 2', image: './assets/suv1.jfif', model: 'Model 2', type: 'mid-range', rentalDetails: { pricePerKm: 12, discount: 25, perDayCost: 700 }, details: 'Comfortable and spacious', gearType: 'automatic', isFrequentRenter: false, loyaltyPoints: 0, extraDiscountRides: 0 },
      { name: 'Car 3', image: './assets/suv2.jfif', model: 'Model 3', type: 'high-end', rentalDetails: { pricePerKm: 15, discount: 30, perDayCost: 1000 }, details: 'Luxury and high performance', gearType: 'automatic', isFrequentRenter: true, loyaltyPoints: 0, extraDiscountRides: 0 },
      { name: 'Car 4', image: './assets/suv3.jfif', model: 'Model 4', type: 'basic', rentalDetails: { pricePerKm: 10, discount: 20, perDayCost: 500 }, details: 'Economical and fuel-efficient', gearType: 'automatic', isFrequentRenter: true, loyaltyPoints: 0, extraDiscountRides: 0 },
      { name: 'Car 5', image: './assets/suv4.jfif', model: 'Model 1', type: 'mid-range', rentalDetails: { pricePerKm: 10, discount: 20, perDayCost: 500 }, details: 'Economical and fuel-efficient', gearType: 'manual', isFrequentRenter: true, loyaltyPoints: 0, extraDiscountRides: 0 },
      { name: 'Car 6', image: './assets/suv5.jfif', model: 'Model 3', type: 'high-end', rentalDetails: { pricePerKm: 10, discount: 20, perDayCost: 500 }, details: 'Economical and fuel-efficient', gearType: 'manual', isFrequentRenter: true, loyaltyPoints: 0, extraDiscountRides: 0 }
    ];
